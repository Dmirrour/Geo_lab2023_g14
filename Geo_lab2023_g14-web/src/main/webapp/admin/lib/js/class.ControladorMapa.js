    ...
    cargarMapaAltaAmbulancia() {
        ...
        this.map.on('click', function (e) {
            ...
            for (var i = 0; i < recorrido.length; i++) {
                ...
                data += punto.longitud + ' ' + punto.latitud;
            ...
            if (i = 1) {
                console.log('LINESTRING(' + data + ')');
                document.getElementById(prefijo + ":rec").value = 'LINESTRING(' + data + ')';
                i = 0;
